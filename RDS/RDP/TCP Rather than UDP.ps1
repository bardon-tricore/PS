##Uses a registry key to force RDP session to use TCP only and not UDP (for the display). This helps with display freezing issues on the remote device. (will not help mouse/keyboard freezing issues).
